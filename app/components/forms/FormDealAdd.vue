<template lang="html">
	<form class="ui form js-form-add-deal form-deal-add" :class="{active: visible}">

	 <div class="field">
		<label>Клиент</label>
		 <div ref="client" class="ui fluid search normal selection dropdown form-deal-add__client">
	 ...
	 <div class="field">
		<label>Строение</label>
		 <div ref="building" class="ui fluid search normal selection dropdown form-deal-add__building">
...
<script>
	...
	export default {
		props: ['cancel', 'ok', 'visible', 'clients', 'buildings'],
		mounted(){
			dropdowns = $('.form-deal-add__client, .form-deal-add__building').dropdown({
				ignoreCase: true
			});
